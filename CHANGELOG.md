...
### Changed
- Fixed the GitHub Actions workflow build platform value to use `AnyCPU`, matching the project configuration required by MSBuild
...
- Added a latest-release download link to the English and Russian README files
